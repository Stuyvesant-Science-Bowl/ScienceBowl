		...
		*/
        ...
        extraQuestions = new int [] {Physics.size() - physicsNum*roundNum, Mathematics.size() - mathematicsNum*roundNum, Biology.size() - biologyNum*roundNum, Chemistry.size() - chemistryNum*roundNum, EarthSpace.size() - earthSpaceNum*roundNum, Energy.size() - energyNum*roundNum};
            ...
            for(int i = 25; i > 0; i--){
				...
				sb.append("0: " + names[subject] + (char)2);
				...
				if(temp[3].equals("Multiple Choice") && temp[4].equals("Short Answer")){
                    ...
                    sb.append("1: Toss Up | Multiple Choice: " +
                                ...
                                "Y) " + temp[9] + "\n\t\t" +
                                "Z) " + temp[10] + (char)2);
                    sb.append("2: Toss Up Answer: " + temp[11] + (char)2);
                    //Bonus Short Answer
                    sb.append("3: Bonus | Short Answer: " + temp[12] + (char)2);
                    sb.append("4: Bonus Answer: " + temp[13] + (char)3);
                    ...
                    sb.append("1: Toss Up | Multiple Choice: " + "\t" + temp[14] + "\n\t\t" + 
                               ...
                               "X) " + temp[16] + "\n\t\t" +
                                "Y) " + temp[17] + "\n\t\t" +
                                "Z) " + temp[18] + (char)2);
                    sb.append("2: Toss Up Answer: " + temp[19] + (char)2);
                    ...
                    sb.append("3: Bonus | Multiple Choice: " + "\t" + temp[20] + "\n\t\t" + 
                                ...
                                "Y) " + temp[23] + "\n\t\t" +
                                "Z) " + temp[24] + (char)2);
                    sb.append("4: Bonus Answer: " + temp[25] + (char)3);
                } else if(temp[3].equals("Short Answer") && temp[5].equals("Multiple Choice")){
                    sb.append("1: Toss Up | Short Answer: " + temp[26] + (char)2);
                    sb.append("2: Toss Up Answer: " + temp[27] + (char)2);
                    //Bonus Multiple Choice
                    sb.append("3: Bonus | Multiple Choice: " + 
                                ...
                                "Y) " + temp[31] + "\n\t\t" +
                                "Z) " + temp[32] + (char)2);
                    sb.append("4: Bonus Answer: " + temp[33] + (char)3);


                } else if(temp[3].equals("Short Answer") && temp[5].equals("Short Answer")){
                    //Toss Up Short Answer
                    sb.append("1: Toss Up | Short Answer: " +  temp[34] + (char)2);
                    sb.append("2: Toss Up Answer: " + temp[35] + (char)2);
                    //Bonus Short Answer
                    sb.append("3: Bonus | Short Answer: " + temp[36] + (char)2);
                    sb.append("4: Bonus Answer: " + temp[37] + (char)3);
                } else {
